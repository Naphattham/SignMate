      ...
      <div className="relative bg-[#FFF9F0] w-full max-w-7xl aspect-[16/10] md:aspect-video rounded-[3rem] border-2 border-black shadow-2xl flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className={`flex flex-col items-center z-10 mt-8 transition-opacity duration-300 ${showLoginModal ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          ...
          <div className="relative mb-6">
            {/* ไอคอนมือ (ใช้ Emoji หรือรูปภาพแทนได้) */}
            <div className="absolute -top-12 right-0 translate-x-1/2 rotate-12 text-6xl drop-shadow-md">
              🤟
            </div>
            {/* ชื่อ SignMate */}
            <h1 className="font-pixel text-8xl md:text-9xl text-black tracking-widest drop-shadow-[4px_4px_0_rgba(0,0,0,0.2)]">
              SignMate
            </h1>
          </div>

          {/* กล่องข้อความภาษาไทย */}
          <div className="bg-white rounded-[2.5rem] px-12 py-6 mb-10 shadow-sm text-center">
            <h2 className="font-thai text-[#4255A3] text-4xl md:text-5xl font-semibold leading-tight">
              ภาษามือ <br />
              ใครว่ายาก?
            </h2>
          </div>
